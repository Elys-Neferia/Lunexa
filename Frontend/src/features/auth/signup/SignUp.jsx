...
export default function SignUp() {
  ...
  return <main className="signup-page">
    ...
    <section className="signup-card" aria-labelledby="signup-heading">
      <header className="signup-header"><div className="lunexa-logo" aria-label="Lunexa">L</div><h1 id="signup-heading">Join the Archive</h1><p>Enter the Midnight Archive and begin your journey.</p></header>
